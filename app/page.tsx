    ...
    >
      ...
      >
        <div className="scratch-reveal" aria-hidden="true">
          ...
          <span className="scratch-date">19 April 2026</span>
        </div>
      ...
      >
        <div className="scratch-place">Udhay &amp; Meenal</div>
        {isRevealed && (
    ...
    <div className="page">
      ...
      <header className="hero">
        <div className="container">
          ...
          >
            <div className="hero-date">19 April 2026 • Amritsar</div>
            <div className="hero-names">Udhay &amp; Meenal</div>
            <div className="hero-place"></div>
            <p className="hero-tagline">
              With the blessings of our families, we invite you to join us in
              celebrating two days of love, traditions, music and memories in
              Amritsar.
            </p>
      ...
      <section id="countdown" className="countdown">
        <div className="container">
          ...
          >
            ...
            <h2>Countdown to 19 April 2026</h2>
            <div className="divider" />
          </motion.div>
          ...
          >
            ...
            <p className="countdown-note">
              Mark your calendars — celebrations begin on 18 April 2026 and
              culminate with the wedding celebrations on 19 April 2026.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          >
            <div className="card">
              ...
              <h3>Udhay Aggarwal</h3>
              <p>
                Son of <strong>Mr. Sidarth Aggarwal</strong> &amp;{" "}
                <strong>Mrs. Shweta Aggarwal</strong>.
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p>
                Daughter of <strong>Mr. Mahesh Aggarwal</strong> &amp;{" "}
                <strong>Mrs. Mohini Aggarwal</strong>.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container">
          <div className="two-column">
            ...
            >
              ...
              {activeLocation === "wedding" ? (
                <>
                  <div className="location-name">Festyn Palais</div>
                  <div className="location-address">
                    Amritsar
                  </div>
                  <a
                    className="muted-link"
                    href="https://maps.google.com/?q=Festyn+Palais+Amritsar"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Open in Google Maps
                ...
                <>
                  <div className="location-name">Taj Swarna, Amritsar</div>
                  <div className="location-address">
                    C-3 Outer, Circular Rd., Opp. Basant Avenue
                    <br />
                    Amritsar - 1430001
                  </div>
                  <p className="location-note">
                    Welcome lunch, Haldi ceremony, and Sehra bandi will be held here as
                    mentioned in the schedule.
                  </p>
                  <a
                    className="muted-link"
                    href="https://www.google.com/maps/search/?api=1&query=Taj+Swarna+Amritsar"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Open in Google Maps
